...
public class ImageConsumerGreyVerOne extends Thread implements ImageConsumer{
	...
	public ImageConsumerGreyVerOne(ImageBuffer b, int position, ImagePath inputPath, int filterValue,DataOutputStream out) {
		this.buffer = b;
	...
	public void run() {
		...
		int i, j, widthStart, widthEnd, heightStart, heightEnd, R, G, B, avg;
